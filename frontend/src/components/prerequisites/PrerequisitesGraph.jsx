...
export default function PrerequisitesGraph({ data }) {
  ...
  // 🔥 process graph whenever data OR courseMap changes
  useEffect(() => {
  ...
  const processGraph = (data) => {
    ...
    // ✅ FIXED LABEL (ReactFlow-safe, multiline works)
...
//       fetch(`${BASE_URL}/prerequisites`)
//         .then((res) => res.json())
//         .then((resData) => setInternalData(resData))
